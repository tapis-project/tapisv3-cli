...
class Packages(BaseController):
    ...
    #     original_package = self.config_manager.get("current", "package")
    #     self.config_manager.add("current", "package", package)
    ...
    #             self.config_manager.add("current", "package", original_package)
